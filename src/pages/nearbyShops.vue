              ...
              <van-cell v-for="item in list">
                <div class="pullbox" @click="openShophome(item.shopId)">
                  ...
                  <div class="textbox" style="">
                    <p>{{item.title}}</p>
                    <p class="titlelist"><img src="../assets/businesses_icon@2x.png" alt=""><span>{{item.shopType}}</span><span style="padding-left: 10px;">人均消费{{item.averageMoney}}元</span><span style="position: absolute;right: 25px;"><100m</span></p>
